...
const Tours = () => {
  ...
  const renderEmptyState = () => (
    <div className="text-center py-16 bg-white/20 backdrop-blur-sm rounded-xl">
        ...
        <h3 className="text-2xl font-bold text-white mb-4">No Tours Available</h3>
  ...
  const renderPagination = () => (
    <div className="flex items-center justify-center space-x-2 mt-8">
        <button
          ...
          className="p-2 rounded-lg border border-gray-300 bg-white/80 text-gray-600 hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
        >
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg font-medium ${
              page + 1 === pagination.page
                ...
                : 'border border-gray-300 bg-white/80 text-gray-600 hover:bg-gray-50'
            }`}
          >
            {page + 1}
          </button>
    ...
    >
      <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  <div className="flex bg-white/20 backdrop-blur-sm rounded-lg p-1">
                    <button onClick={() => setViewMode('grid')} className={`p-2 rounded ${viewMode === 'grid' ? 'bg-white/80 shadow-sm text-green-600' : 'text-gray-200'}`}><Grid className="w-4 h-4" /></button>
                    <button onClick={() => setViewMode('list')} className={`p-2 rounded ${viewMode === 'list' ? 'bg-white/80 shadow-sm text-green-600' : 'text-gray-200'}`}><List className="w-4 h-4" /></button>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            {loading ? (
              <div className="text-center py-16"><div className="animate-spin rounded-full h-16 w-16 border-b-2 border-white mx-auto"></div></div>
            ) : error ? (
                <div className="text-center py-16 bg-red-500/20 backdrop-blur-sm text-white rounded-xl">
