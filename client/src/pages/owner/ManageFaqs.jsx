                ...
                faqs.length > 0 ? (
                    ...
                    <div className="col-span-full text-center py-16 bg-gray-50 rounded-lg shadow-inner">
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            It looks like there are no frequently asked questions yet. Start by adding one below.
                        </p>
                        <button
                            onClick={() => handleOpenModal()}
                            className="mt-6 inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white font-medium px-4 py-2 rounded-lg shadow-md transition"
                        >
                            <Plus size={18} /> Add Your First FAQ
                        </button>
                    </div>
                )
            )}
                        ...
                        <div className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    placeholder="booking, payment, cancellation"
                                    className="w-full p-2 border rounded-md"
                                />
