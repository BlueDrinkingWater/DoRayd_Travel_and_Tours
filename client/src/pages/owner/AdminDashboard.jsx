...
// Overwriting formatDate to be more specific for this page if needed, or use the one from ManageBookings
...
// --- SECURE IMAGE COMPONENTS (COPIED FROM MANAGEBOOKINGS) ---
...
// This modal is now self-contained and uses the same logic as ManageBookings.jsx
const BookingDetailModal = ({ booking: initialBooking, onClose, onUpdate }) => {
    const [selectedBooking, setSelectedBooking] = useState(initialBooking); // Use internal state
    ...
    // Refetch booking details if initialBooking changes (e.g., opening a new one)
    useEffect(() => {
    ...
    const handleStatusUpdate = async (newStatus) => {
        ...
        try {
            ...
            onUpdate(); // This will refetch data on the main dashboard
            ...
            {selectedBooking && (
                <BookingDetailModal
                    ...
                    onUpdate={() => {
                        ...
                        // Don't close modal, let internal state handle it
