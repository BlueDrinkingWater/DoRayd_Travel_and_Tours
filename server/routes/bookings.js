...
import { upload, uploadAttachment } from '../middleware/upload.js';
...
router.route('/:id/status')
    .put(auth, checkPermission('bookings', 'write'), uploadAttachment.single('attachment'), updateBookingStatus);

router.route('/:id/cancel')
    .patch(auth, checkPermission('bookings', 'write'), uploadAttachment.single('attachment'), cancelBooking);
